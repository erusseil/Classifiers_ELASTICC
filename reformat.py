...
ftransfer = 'ftransfer_elasticc_v2_2023-08-12_245226'
path = f'/media/ELAsTICC/Fink/first_year/{ftransfer}/classId={target}/'
...
if not os.path.exists(f'/media/ELAsTICC/Fink/first_year/{ftransfer}/aggregated/'):
    os.makedirs(f'/media/ELAsTICC/Fink/first_year/{ftransfer}/aggregated/')

final.to_parquet(f'/media/ELAsTICC/Fink/first_year/{ftransfer}/aggregated/classId={target}.parquet')
